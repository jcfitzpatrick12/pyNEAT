...
class genome_builder:
    def build_genome(self,requested_node_labels,requested_connection_genes,**kwargs):
        #default number of nodes are those which are requested
        default_num_nodes = len(requested_node_labels)
        ...
        node_genes[:default_num_nodes,0]=requested_node_labels
